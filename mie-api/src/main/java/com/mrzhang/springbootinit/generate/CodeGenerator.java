package com.mrzhang.springbootinit.generate;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        // 指定生成参数
        String packageName = "com.mrzhang.springbootinit";
        ...
        String outputPath = String.format("%s/com.mrzhang.springbootinit/包名/%s类后缀.java", projectPath, upperDataKey);

        // 1、生成 Controller
        // 指定生成路径
        inputPath = projectPath + File.separator + "src/main/resources/templates/TemplateController.java.ftl";
        outputPath = String.format("%s/com.mrzhang.springbootinit/controller/%sController.java", projectPath, upperDataKey);
        // 生成
        ...
        outputPath = String.format("%s/com.mrzhang.springbootinit/service/%sService.java", projectPath, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        ...
        outputPath = String.format("%s/com.mrzhang.springbootinit/service/impl/%sServiceImpl.java", projectPath, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        ...
        outputPath = String.format("%s/com.mrzhang.springbootinit/model/dto/%sAddRequest.java", projectPath, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        inputPath = projectPath + File.separator + "src/main/resources/templates/model/TemplateQueryRequest.java.ftl";
        outputPath = String.format("%s/com.mrzhang.springbootinit/model/dto/%sQueryRequest.java", projectPath, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        inputPath = projectPath + File.separator + "src/main/resources/templates/model/TemplateEditRequest.java.ftl";
        outputPath = String.format("%s/com.mrzhang.springbootinit/model/dto/%sEditRequest.java", projectPath, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        inputPath = projectPath + File.separator + "src/main/resources/templates/model/TemplateUpdateRequest.java.ftl";
        outputPath = String.format("%s/com.mrzhang.springbootinit/model/dto/%sUpdateRequest.java", projectPath, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        ...
        outputPath = String.format("%s/com.mrzhang.springbootinit/model/vo/%sVO.java", projectPath, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
