...
import com.mrzhang.springbootinit.model.dto.interfaceInfo.InterfaceInfoAddRequest;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        // 判断该接口是否可以调用
        com.mrzhang.mieapiclientsdk.model.User user = new com.mrzhang.mieapiclientsdk.model.User();
        user.setUsername("test");
        String username = mieApiClient.getUsernameByPost(user);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        MieApiClient tempClient = new MieApiClient(accessKey, secretKey);
        Gson gson = new Gson();
        com.mrzhang.mieapiclientsdk.model.User user = gson.fromJson(userRequestParams, com.mrzhang.mieapiclientsdk.model.User.class);
